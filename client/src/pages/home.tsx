        ...
        <div className="liquid-glass-content flex items-center justify-between px-6 py-2">
          ...
          <div className="liquid-glass-buttons flex items-center space-x-2.5">
            <Button 
              variant="ghost" 
              size="sm" 
              className="liquid-glass-btn-morph liquid-glass-btn-outline px-3 py-1.5 h-auto transition-transform duration-300 hover:transform hover:-translate-y-1 rounded-full"
              style={{
