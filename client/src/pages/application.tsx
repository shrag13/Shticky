        ...
        <Card className="shadow-lg border-0 bg-white/90 backdrop-blur-sm">
          ...
          <CardContent>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              {/* Account Information */}
              <div className="space-y-4 p-6 rounded-lg border-2" style={{backgroundColor: '#F5F3F1', borderColor: '#9A7B60'}}>
              ...
              <div className="space-y-4 p-6 rounded-lg border-2" style={{backgroundColor: '#F5F3F1', borderColor: '#A89182'}}>
              ...
              <div className="space-y-4 p-6 rounded-lg border-2" style={{backgroundColor: '#F5F3F1', borderColor: '#686346'}}>
              ...
              <div className="space-y-4 p-6 rounded-lg border-2" style={{backgroundColor: '#F5F3F1', borderColor: '#1D2915'}}>
